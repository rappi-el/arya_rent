  ...
  <div class="row">
    ...
    <div class="col">
      <div class="card" style=" border-radius: 10px; margin-top: 15px; border-color: rgb(255, 255, 255); ">
        ...
        <center><img src="<?php echo e(env('NO_IMAGE_URL')); ?>" class="center gradient_image" width="240" height="200" /></center>
        <div class="card-body ">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Arya-rent-main\resources\views/main.blade.php ENDPATH**/ ?>